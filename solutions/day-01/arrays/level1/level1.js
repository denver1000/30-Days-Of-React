...
let mixedDataTypes = ["Asd", 0, 2, [1, 2, 3], 4, "bcd"];
...
console.log(itCompanies[Arr.length - 1]);
...
let check = itCompanies.indexOf("Babazon");
check != -1 ? console.log(itCompanies[check]) : console.log("Not found");
